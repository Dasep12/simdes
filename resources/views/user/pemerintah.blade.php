        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group text-center">
                    <img height="300px" width="600px" src="lampiran/pemerintah-desa.jpg" class="img-fluid">
                </div>
                <h2 class="">
                ...
                <p style="text-align: justify;">Kepala urusan berkedudukan sebagai unsur staf sekretariat. Kepala urusan bertugas membantu Sekretaris Desa dalam urusan pelayanan administrasi pendukung pelaksanaan tugas-tugas pemerintahan. Untuk melaksanakan tugas kepala urusan mempunyai fungsi:</p>
                <ol style="text-align: justify;">
                ...
                <p style="text-align: justify;">Kepala Kewilayahan atau sebutan lainnya berkedudukan sebagai unsur satuan tugas kewilayahan yang bertugas membantu Kepala Desa dalam pelaksanaan tugasnya di wilayahnya. Untuk melaksanakan tugas Kepala Kewilayahan/Kepala Dusun memiliki fungsi:</p>
                <ol style="text-align: justify;">
                ...
                <p style="text-align: justify;">Kepala seksi berkedudukan sebagai unsur pelaksana teknis. Kepala seksi bertugas membantu Kepala Desa sebagai pelaksana tugas operasional. Untuk melaksanakan tugas Kepala Seksi mempunyai fungsi:</p>
                <ol>
