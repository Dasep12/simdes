...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-lg-12">
            <form action="/admin/gamas/add" method="post" enctype="multipart/form-data">
                @csrf
                <label>Nama Lembaga</label>
                <input type="text" class="form-control @error('namaLembaga') is-invalid @enderror" name="namaLembaga" value="{{ old('namaLembaga') }}">
                @error('namaLembaga')
